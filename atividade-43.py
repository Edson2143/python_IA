...
#atividade_43
#estrutura repetição loop while e variaveis auxiliares
#escreva um programa quepergunteao usuario um nao e imprimao proximo ano bissexto




#atividade 20 estrutura condicional: IF: atividade
#escreva um programa que solicite ao ususario dois numeros e uma operaçao . se a operaçao for adicionar, multiplicar ou subtrair, 
#o programa devera calcular  e imprimir o resultdado da operaçao com os numeros fornecidos se o ususario digitar qualquer outra coisa,
#o progrma nao devera imprimir nada.


numero_1 = int(input("numero um = "))
numero_2 = int(input("numero 2 = "))
operacao = input("Qual operacao:")
if operacao == ("soma"):
    print (f"soma = {numero_1 + numero_2}")
elif operacao == ("multiplicacao"):
    print (f"multipli = {numero_1 * numero_2}")
elif operacao == ("divisao"): 
    print (f"divisao = {numero_1 / numero_2}")
